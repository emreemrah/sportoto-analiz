...
- Bu skill'in aktif çalışma projesi E:\flt\kodu cevir'dir; geliştirme ve kod değişiklikleri yalnız bu dizin içinde yapılır.
...
Ham skill'deki şu talimatlar bu projede zorunlu değildir; proje bağlamına bağlı **seçeneklerdir** (dayatma değil):
