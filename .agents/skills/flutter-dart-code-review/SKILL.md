...
- Bu skill'in aktif çalışma projesi E:\Spor Toto Master Analiz içindeki flutter_app'tir; inceleme ve kod değişiklikleri yalnız burada yapılır.
- C:\Users\emrah\sportoto-analiz = salt-okunur eski uygulama referansıdır; yalnız örnek/karşılaştırma amacıyla okunur, orada hiçbir dosya değiştirilmez.
- E:\Yeni sportoto ve diğer proje kopyaları kapsam dışıdır.
- Kullanıcının açık kararları, AGENTS.md ve doğrulanmış proje kuralları bu skill'deki genel önerilerden üstündür.
...
### İnceleme Odaklı Ek Kurallar

- Kullanıcı yalnız inceleme istediğinde kaynak kod değiştirilmemelidir.
- Yalnızca %80'den yüksek güvenli bulgular raporlanmalıdır.
- Bulgular P0/P1/P2/P3 şeklinde sınıflandırılmalıdır.
- Stil tercihi ile gerçek hata birbirinden ayrılmalıdır.
- Değişmeyen kod yalnız kritik güvenlik veya veri kaybı riski varsa raporlanmalıdır.
- "80% test coverage", "her widget ayrı dosyada olmalı" ve benzeri genel hedefler proje bağlamına göre değerlendirilmelidir; otomatik zorunluluk değildir.
- Mevcut görselleri değiştiren öneriler açık kanıt ve kullanıcı onayı olmadan uygulanmamalıdır.

> **Kaynak notu:** Orijinal skill `flutter-dart-code-review` — kaynak: https://github.com/affaan-m/ECC/tree/main/skills/flutter-dart-code-review · alınan commit SHA: `ed387446052dfbc6b52de149406b70efa65edc59`. Spor Toto Analiz için proje-yerel güvenlik ve mimari kuralları eklenmiştir. Orijinal içerik ve kaynak atfı korunmuştur.
