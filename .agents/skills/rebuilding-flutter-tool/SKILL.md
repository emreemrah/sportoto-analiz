...
>
> Bu skill bir Spor Toto uygulama dosyasını, ekranı veya iş mantığını değiştirmez.

## Step 1: Execute
* **Action:** Bu skill dizininden (`.Codex/skills/rebuilding-flutter-tool/`) SKILL.md'ye göre göreli yolla rebuild script'ini çalıştırın: `dart scripts/rebuild.dart`
* **Not:** Mutlak Windows yolu gömülmez; yol SKILL.md konumuna göre görelidir. Bu depodaki gerçek konum: `E:\Spor Toto Master Analiz\.Codex\skills\rebuilding-flutter-tool\scripts\rebuild.dart`.
